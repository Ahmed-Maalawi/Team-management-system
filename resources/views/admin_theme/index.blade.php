    ...
    <div class="row">
        ...
        <div class="col-xlg-3 col-md-6 col-12 mb-30">
            <div class="top-report">
                ...
                <!-- Head -->
                <div class="head">
                    <h4>Total Volunteers Contribution </h4>
                    <a href="#" class="view"><i class="zmdi zmdi-eye"></i></a>
                </div>
                    ...
                    <ul class="todo-list">
                        ...
                        <li class="done">
                            ...
                            <div class="list-content">
                                <p>Sed ut perspiciatis unde _____ iste natus error. </p>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="list-content">
                                <p>Mistaken idea of denouncing ________. </p>
                            </div>
                            <div class="list-action right">
                                <button class="remove"><i class="zmdi zmdi-delete"></i></button>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="list-content">
                                <p>Nor again is there ______ who loves. </p>
                            </div>
                            <div class="list-action right">
                                <button class="remove"><i class="zmdi zmdi-delete"></i></button>
                            </div>
                            ...
                            <li>
                                <div class="widget-chat">
                                    ...
                                    <div class="body">
                                        ...
                                        <div class="content">
                                            <p>Lorem Ipsum is simply _____ text of the printing ___ typesetting industry. Lorem Ipsum ___ been the industry's standard _____ text </p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="widget-chat">
                                    ...
                                    <div class="body">
                                        ...
                                        <div class="content">
                                            <p>Lorem Ipsum is simply _____ text of the printing ___ typesetting industry. Lorem Ipsum ___ been the. </p>
                                        </div>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="news-update-inner">
                        ...
                        <div class="news-item">
                            ...
                            <div class="content">
                                ...
                                <!-- Title -->
                                <h4 class="title"><a href="#">Sed do eiusmod tempor __________ ut labore. Lorem Ipsum __ simplydummy text of the ________ and typesetting industry. </a></h4>
                                <!-- Meta -->
                                <ul class="meta">
                        ...
                        <div class="news-item">
                            ...
                            <div class="content">
                                ...
                                <!-- Title -->
                                <h4 class="title"><a href="#">Sed do eiusmod tempor ______. Lorem Ipsum is simplydummy ____ of the printing and. </a></h4>
                                <!-- Meta -->
                                <ul class="meta">
                                    <li><i class="zmdi zmdi-time"></i>10 Houre ago </li>
                        ...
                        <div class="news-item">
                            ...
                            <div class="content">
                                ...
                                <!-- Title -->
                                <h4 class="title"><a href="#">Sed do eiusmod typesetting ________. Lorem Ipsum is simplydummy ____ of the printing and ___________ industry. </a></h4>
                                <!-- Meta -->
                                <ul class="meta">
                                    <li><i class="zmdi zmdi-time"></i>10 Houre ago </li>
