                            ...
                            <ul class="header-notification-area">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        ...
                                                        <div class="content">
                                                            ...
                                                            <p>There are many variations __ passages of Lorem Ipsum _________.  </p>
                                                        </div>
                                ...
                                <li class="adomx-dropdown col-auto">
                                    ...
                                    <div class="adomx-dropdown-menu dropdown-menu-notifications">
                                        <div class="head">
                                            <h5 class="title">You have 4 new ____________. </h5>
                                        </div>
                                        <div class="body custom-scroll">
                                            <ul>
                                                <li>
                                                    <a href="#">
                                                        ...
                                                        <p>There are many variations __ pages available. </p>
                                                        <span>11.00 am   _____ </span>
                                                    </a>
