    ...
    <div class="side-header-inner custom-scroll">
        ...
        <nav class="side-header-menu" id="side-header-menu">
            <ul>
                ...
                <li class="has-sub-menu"><a href="#"><i class="ti-package"></i>  <span>المخزن </span></a>
                    <ul class="side-header-sub-menu text-capitalize">
                        <li><a href="{{ route('add.report') }}"><span>اضافة تقرير </span></a></li>
